<template>
  <div class="container mx-auto">
    <div class="pt-5">
      ...
      <table 
        class="sp-rate-table small w-100 mx-auto my-5"
      ...
      <div class="py-5">
        ...
        <tableReward class="sp-rate-table small"/>
...
<script>
import tableReward from '../reward/table_reward.vue'
...
<style lang="scss" scoped>
  /deep/ .sp-rate-table{
    ...
    tr{
      &.bg-gold{
        background-color: #E4B947 !important;
        color: #222;
      }
      &.head-row{
        td{
          ...
          padding-top: 5px;
          padding-bottom: 5px;
          border-bottom: 3px solid $bg_table;
          color: #fff;
